...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex h-16 items-center justify-around border-t border-gray-200 bg-white px-2">
      {tabs.map(({ href, label, icon: Icon }) => {
        ...
        return (
          ...
          >
            <Icon className={`h-6 w-6 ${active ? 'text-green-600' : 'text-gray-400'}`} />
            {label}
          </Link>
        )
      })}
